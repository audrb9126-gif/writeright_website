const translations = {
  ko: {
    ...
    adv1Title: "심층 리포트",
    adv1Desc: "단순히 틀린 것만 알려주지 않습니다. 왜 틀렸는지, 내 주요 취약점은 무엇인지 상세한 AI 분석 리포트를 제공합니다.",
    adv2Title: "AI 롤플레잉",
    adv2Desc: "실제 원어민과 대화하듯 AI 튜터와 다양한 상황극을 연습하며 실전 감각을 키워보세요.",
    adv3Title: "섀도우 타이핑",
    adv3Desc: "교정된 완벽한 문장을 보며 직접 타이핑해 보세요. 눈으로만 보는 것보다 훨씬 더 빠르게 언어 실력이 향상됩니다.",
    adv4Title: "수신 메시지 퀵 번역",
    adv4Desc: "상대방이 보낸 외국어 메시지, 앱 밖으로 나갈 필요 없습니다. 복사만 하면 플로팅 팝업이 즉시 뜻과 발음, 슬랭의 뉘앙스까지 알려줍니다.",
  ...
  en: {
    ...
    adv1Desc: "We don't just point out mistakes. Get a comprehensive AI analysis of why you were wrong and discover your core weaknesses.",
    adv2Title: "AI Roleplaying",
    adv2Desc: "Practice real-life scenarios with your AI tutor as if you were talking to a native speaker.",
    adv3Title: "Shadow Typing",
    adv3Desc: "Type out the corrected sentences yourself. This active learning approach improves your skills much faster than just reading.",
    adv4Title: "In-App Quick Translate",
    adv4Desc: "Never leave your messenger. Copy any received message and get instant translations, pronunciations, and slang nuances via a floating popup.",
